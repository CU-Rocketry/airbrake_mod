...
#define MAG_SCK_Pin GPIO_PIN_12
#define MAG_SCK_GPIO_Port GPIOE
#define MAG_MOSI_Pin GPIO_PIN_14
#define MAG_MOSI_GPIO_Port GPIOE
...
#define BTN_1_EXTI_IRQn EXTI1_IRQn
#define BTN_2_Pin GPIO_PIN_2
#define BTN_2_GPIO_Port GPIOD
#define BTN_2_EXTI_IRQn EXTI2_IRQn
